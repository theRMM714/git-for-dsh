 ...
 *
 * Used where a file must be hidden rather than read: the enforced hooks path, and the user-level
 * and system configuration. NUL on Windows, /dev/null elsewhere.
 */
...
export const ENFORCED_CONFIG = Object.freeze([
  ...
  { key: 'core.hooksPath', value: NULL_DEVICE },
